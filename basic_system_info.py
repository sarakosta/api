...
# control site
plants_controlled, animals_controlled, interactions_controlled = f.print_graph_info("data/gcontrolled.csv")
...
# restored site
plants_restored, animals_restored, interactions_restored = f.print_graph_info("data/grestored.csv")
...
# -- Number of visits --
# control site
num_visits_c = f.number_of_visits("data/controlled_pollinators.csv")
print("Number of visits in controlled site:", num_visits_c)
# restored site
num_visits_r = f.number_of_visits("data/restored_pollinators.csv")
