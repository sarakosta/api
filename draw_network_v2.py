...
def print_network_old(file_adj_matrix, file_plants, common_names, file_animals):
...
def print_network(file_adj_matrix, file_plants, file_animals, common_names):
...
print_network("gcontrolled.csv", "controlled_sorted.csv", "controlled_animal_sorted.csv" ,common_plants)
